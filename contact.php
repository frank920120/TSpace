                    ...
                    <form class="mail-form">
                                    ...
                                    <span class="input input--haruki">
                                        ...
                                        <span class="textarea-container">
                                                <p class="textarea-title" title="Click to Open Textarea">Content</p>
                                        ...
                                        <span class="radio-group">
                                                <h4>Do you mind telling us about your gender?</h4>
                                        ...
                                        <span class="select-group">
                                                <h4>Do you mind telling us about your age?</h4>
                                        ...
                                        <span class="checkbox-container">
                                                <h4>Which way would you like to receive our feedback?</h4>
